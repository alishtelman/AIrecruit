...
const STARTABLE_MODULE_TYPES = new Set([
  "adaptive_interview",
  "system_design",
...
export default function EmployeeInvitePage() {
  ...
  const flowQuestionLabel =
    currentModuleType === "system_design"
      ...
      : currentModuleType === "behavioral_interview"
      ? t("flow.behavioralInterviewQuestions")
      : currentModuleType === "coding_task"
      ? t("flow.codingTaskQuestions")
      : currentModuleType === "sql_live"
      ? t("flow.sqlLiveQuestions")
      : currentModuleType === "written_communication"
      ? t("flow.writtenCommunicationQuestions")
  ...
  return (
    <div className="rounded-2xl border border-slate-800 bg-slate-950/60 p-4">
      ...
      <div className="mt-3 flex flex-wrap gap-2 text-xs text-slate-400">
        ...
        ) : item.module_type === "system_design" || item.module_type === "behavioral_interview" || item.module_type === "coding_task" || item.module_type === "sql_live" || item.module_type === "written_communication" ? (
